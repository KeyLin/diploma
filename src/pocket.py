...
class Pocket(object):
    ...
    def __init__(self, configure):
        ...
        self.decoder = Decoder(config_pocket)        #Create the decoder from the config

        self.decoder.start_utt()
        self.in_speech_bf = True         #Needed to get the state, when you are speaking/not speaking -> statusbar
        ...
        if self.decoder.get_in_speech() != self.in_speech_bf:
            ...
            if not self.in_speech_bf:
                ...
                try:
                    ...
                    pass
                self.decoder.start_utt()            #Say to the decoder, that a new "sentence" begins
