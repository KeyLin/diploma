...
def reset():
	...
	os.system('sudo echo 14 > /sys/class/gpio/unexport')
	os.system('sudo echo 0 > /sys/class/gpio/gpio15/value')
	os.system('sudo echo 15 > /sys/class/gpio/unexport')
	os.system('sudo echo 0 > /sys/class/gpio/gpio18/value')
	os.system('sudo echo 18 > /sys/class/gpio/unexport')
	os.system('sudo echo 0 > /sys/class/gpio/gpio23/value')
	os.system('sudo echo 23 > /sys/class/gpio/unexport')
